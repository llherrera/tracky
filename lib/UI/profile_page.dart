    ...
    return Column(
      ...
      children: <Widget>[
          ...
          children: <Widget>[
            Column(
              ...
              children: const <Widget>[
                Text('Tania', style: TextStyle(color: Colors.white, fontSize: 30),),
                Text('Barranquilla, Atlantico', style: TextStyle(color: Colors.white, fontSize: 20),),
              ],
            ),
            const CircleAvatar(
              radius: 50,
        ...
        Row(
          ...
          children: <Widget>[
            Expanded(
              child: OutlinedButton(
                ...
                child: Row(
                  ...
                  children: const <Widget>[
                    Text('Edit Profile', style: TextStyle(color: Colors.white, fontSize: 20),),
            ...
            OutlinedButton(
              ...
              child: Row(
                children: const <Widget>[
                  Text('Log out', style: TextStyle(color: Colors.red, fontSize: 20),),
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: <Widget>[
            const Text('Last Activity', style: TextStyle(color: Colors.white, fontSize: 15),),
            TextButton(
              onPressed: () {},
              child: const Text(
                'View all',
              ...
              //Padding(padding: const EdgeInsets.symmetric(vertical: 10),
                Column(
                  ...
                  children: const <Widget>[
                    ...
                    Text('Best time: 40:00', style: TextStyle(color: Colors.white, fontSize: 20),),
                    Text('Distance: 20 km', style: TextStyle(color: Colors.white, fontSize: 20),),
                    Text('Date: March 8, 2022', style: TextStyle(color: Colors.white, fontSize: 20),),
                  ],
                ),
              //Padding(padding: const EdgeInsets.symmetric(vertical: 10),
                Column(
                  ...
                  children: const <Widget>[
                    Padding(padding: EdgeInsets.only(top: 5, bottom: 10),
                      child: Text('Running', style: TextStyle(color: Color(0xFFADCEE1)),),
                    ),
                    Text('Best time: 40:00', style: TextStyle(color: Colors.white, fontSize: 20),),
                    Text('Distance: 20 km', style: TextStyle(color: Colors.white, fontSize: 20),),
                    Text('Date: March 8, 2022', style: TextStyle(color: Colors.white, fontSize: 20),),
